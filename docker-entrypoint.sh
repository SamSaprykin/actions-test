...
git clone --single-branch --branch $INPUT_DESTINATION_BRANCH "https://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@github.com/$INPUT_DESTINATION_REPO.git" "$CLONE_DIR"
