...
git clone --single-branch --branch $INPUT_DESTINATION_BRANCH "https://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@github.com/SamSaprykin/dest-actions.git" "$CLONE_DIR"
